$(function(){
  const role = localStorage.getItem("user_role");
		...
		if(role === null){
			...
			$("#login-link").append('<button onclick="lougout()"  type="button"  class="btn btn-link" style="color: #ffffff;"><i	class="fa-solid fa-right-to-bracket" style="color: #ffffff;"></i> LOGOUT</button>')
